-- ============================================================
-- 14_add_discount_fields_for_fe_orders.sql
-- Expose order-level discount amounts in mdw.v_UnifiedOrders so
-- /api/fe/orders can show Shopee highlighted discount lines.
-- ============================================================
